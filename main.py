...
from handlers import start,get_age,get_contact,get_full_name,confirm_data,start_register
...
def main():
    ...
    register_handler = ConversationHandler(
        entry_points=[CallbackQueryHandler(start_register, pattern=r"^start_register")],
        states={
